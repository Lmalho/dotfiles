...
local prompts = {
	...
	Spelling = "Please correct any grammar and spelling errors in the following text. Don't return the full text. Print only the errors you found.",
	Wording = "Please improve the grammar and wording of the following text. Return only the differences you found.",
